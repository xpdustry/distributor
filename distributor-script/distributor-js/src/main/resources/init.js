...
const run = method => new Runnable()
{
    run: method
}
const boolf = method => new Boolf()
{
    get: method
}
const boolp = method => new Boolp()
{
    get: method
}
const floatf = method => new Floatf()
{
    get: method
}
const floatp = method => new Floatp()
{
    get: method
}
const cons = method => new Cons()
{
    get: method
}
const prov = method => new Prov()
{
    get: method
}
const func = method => new Func()
{
    get: method
}
const runner = method => new Packages.arc.util.CommandHandler.CommandRunner()
{
    accept: method
}

const debug = function (/*text, args...*/) {
    Log.debug(arguments[0], Array.from(arguments).splice(1, arguments.length))
}
const info = function (/*text, args...*/) {
    Log.info(arguments[0], Array.from(arguments).splice(1, arguments.length))
}
const warn = function (/*text, args...*/) {
    Log.warn(arguments[0], Array.from(arguments).splice(1, arguments.length))
}
const err = function (/*text, args...*/) {
    Log.err(arguments[0], Array.from(arguments).splice(1, arguments.length))
}
...
const printf = function (/*text, args...*/) {
    Packages.java.lang.System.out.printf(arguments[0], Array.from(arguments).splice(1, arguments.length))
}
