...
public class CommandInvoker implements CommandRunner<Playerc>, ContextRunner<Playerc>{
    ...
    private final @NotNull CommandContextFactory factory;

    public CommandInvoker(@NotNull Command<Playerc> command, @NotNull CommandContextFactory factory){
    ...
    public CommandInvoker(@NotNull Command<Playerc> command){
        this(command, CommandContextFactory.DEFAULT);
    }
    ...
    public void handleContext(@NotNull CommandContext<Playerc> ctx){
        ...
        try{
            ...
            }else bundle.send("exc.command.arg.size.few", e.getMinArgumentSize(), e.getActualArgumentSize());
            ...
            }else bundle.send("exc.command.arg.validation", e.getParameter().getName(), e.getArgument());
    ...
    public @NotNull CommandContextFactory getFactory(){
        return factory;
    }

    @FunctionalInterface
    public interface CommandContextFactory{
        CommandContextFactory DEFAULT = CommandContext::new;
