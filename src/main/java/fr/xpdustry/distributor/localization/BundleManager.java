...
import fr.xpdustry.distributor.string.Formatter;

import java.io.*;
import java.util.*;
import java.util.concurrent.*;

// TODO Check the Bundle Manager
public class BundleManager extends Bundle implements fr.xpdustry.distributor.string.Formatter{
    protected final ConcurrentHashMap<String, Bundle> bundles;
    private final fr.xpdustry.distributor.string.Formatter formatter;

    public BundleManager(Locale locale){
        this(locale, fr.xpdustry.distributor.string.Formatter.defaultFormatter);
    }
