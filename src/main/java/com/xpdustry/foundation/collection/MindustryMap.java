...
/// A wrapper [Map] for an [ObjectMap].
///
/// @param <K> the type of the keys
/// @param <V> the type of the values
final class MindustryMap<K, V extends @Nullable Object> extends AbstractMap<K, V> {
    ...
    private void checkNullKey(final @Nullable Object o) {
        if (o == null) {
            throw new NullPointerException("MindustryMap does not support null keys");
        }
    }
