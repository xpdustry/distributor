...
import com.xpdustry.distributor.command.lamp.actor.MindustryPermissionFactory;
import com.xpdustry.distributor.command.lamp.actor.MindustrySenderResolver;
import com.xpdustry.distributor.command.lamp.exception.MindustryExceptionHandler;
import com.xpdustry.distributor.command.lamp.hooks.MindustryCommandHooks;
import com.xpdustry.distributor.command.lamp.parameters.ContentParameterType;
import com.xpdustry.distributor.command.lamp.parameters.PlayerParameterType;
import com.xpdustry.distributor.command.lamp.parameters.TeamParameterType;
...
public final class MindustryVisitors {
    ...
    /**
     * Adds support for the {@link com.xpdustry.distributor.command.lamp.annotation.Permission} annotation
     *
     * @param <A> The actor type
     * @return This visitor
     */
